...
<body>
    <form id="form1" runat="server">
        <div>
			...
			<div><langbry>1</langbry></div>
			<div><xl-lang>2</xl-lang></div>
			<div><asp:Label ID="lblTest" runat="server"></asp:Label></div>
			<div><asp:Label ID="lblGetCode" runat="server"></asp:Label></div>
        </div>
    </form>
